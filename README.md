...
## 2026-09-08 Floating Navigator update
- Long detail pages now show a floating context navigator after the user scrolls past the hero.
- Desktop: right-side rail with Main / AI / LIVE / PARK / WC / EAT / HOME / VOICE, and the active section is highlighted.
- Mobile/tablet: bottom dock always keeps Main, LIVE, NOW and an expandable shortcut menu available.
- Section anchors use scroll-margin so destination titles do not hide behind navigation chrome.
